...
//VAREAVES DE CONEXAO COM O BANCO
    ...
    public TelaPrincipalJFrame() {
        ...
        // ESTANCIANDO ACLASSE PARA DATA E HORA
    ...
    public void pesquisarAltorizada() {
        ...
        try {
            stmt = (com.mysql.jdbc.PreparedStatement) con.prepareStatement("SELECT * FROM autorizada WHERE nome_autorizada LIKE ?");
            stmt.setString(1, jTextFieldPesquisaFabricante.getText()+ "%");           
            rs = stmt.executeQuery();
            
            //rs2xml.jar Trazer a tabela
            jTableNomeAutorizada.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    //METODO PARA PREENCHER CAMPOS COM CONTEUDO DA TABELA
    
    public void preencherAltorizada(){
        int setar = jTableNomeAutorizada.getSelectedRow();
        jTextFieldIdAutorizada.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 0).toString());
        jTextFieldNomeAltorizada.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 1).toString());
        jFormattedTextFieldContFab1.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 2).toString());
        jFormattedTextFieldContFab2.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 3).toString());
        jFormattedTextFieldContFab3.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 4).toString());
        jFormattedTextFieldCep.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 5).toString());
        jTextFieldBairroFabricante.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 6).toString());
        jTextFieldCidadeFabricante.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 7).toString());
        jComboBoxEstadoFabricante.setSelectedItem(jTableNomeAutorizada.getModel().getValueAt(setar, 8).toString());
        jTextFieldEnderecoFabricante.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 9).toString());
        jTextFieldComplementoFabricante.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 10).toString());
        jTextFieldDocNecessario.setText(jTableNomeAutorizada.getModel().getValueAt(setar, 11).toString());     
    }    
    ...
    private void initComponents() {
        ...
        jButtonComp2 = new javax.swing.JButton();
        jTextFieldImagemComp2 = new javax.swing.JTextField();
        ...
        jTextFieldIdLaudo1 = new javax.swing.JTextField();
        jFormattedTextFieldDataLaudo = new javax.swing.JFormattedTextField();
        jLabelDataLaudo = new javax.swing.JLabel();
        jLabelProduto10 = new javax.swing.JLabel();
        jTextFieldModeloLaudo = new javax.swing.JTextField();
        ...
        jTextFieldImagemComp1 = new javax.swing.JTextField();
        jButtonComp1 = new javax.swing.JButton();
        ...
        jTableNomeAutorizada = new javax.swing.JTable();
        jPanelDadosGarantia1 = new javax.swing.JPanel();
        jLabeContatoFabricante3 = new javax.swing.JLabel();
        jFormattedTextFieldContFab1 = new javax.swing.JFormattedTextField();
        jLabeContatoFabricante4 = new javax.swing.JLabel();
        jFormattedTextFieldContFab2 = new javax.swing.JFormattedTextField();
        jLabeContatoFabricante5 = new javax.swing.JLabel();
        jFormattedTextFieldContFab3 = new javax.swing.JFormattedTextField();
        ...
        jLabeDocNecessario3 = new javax.swing.JLabel();
        ...
        jPanelTelaLaudo.add(jFormattedTextFieldDataNota);
        jFormattedTextFieldDataNota.setBounds(590, 90, 110, 30);
        ...
        jTextFieldNomeCli.setBounds(120, 30, 370, 30);
        ...
        jTextFieldPesquisaTipoProduto.setBounds(160, 300, 690, 30);

        jLabelTipoProduto.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabelTipoProduto.setText("Pesquisar Produto");
        jPanel1.add(jLabelTipoProduto);
        jLabelTipoProduto.setBounds(20, 300, 140, 30);
        ...
        jLabelTipoNumeroNota.setBounds(700, 30, 100, 30);
        ...
        jTextFieldNumeroNota.setBounds(800, 30, 200, 30);
        ...
        jLabelProblemaCli.setBounds(530, 70, 210, 30);
        ...
        jTextFieldProblemaCli.setBounds(720, 70, 320, 30);
        ...
        jLabelDiagnostico.setBounds(20, 70, 100, 30);
        ...
        jTextFieldLaudo.setBounds(120, 70, 400, 30);

        jButtonComp2.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jButtonComp2.setText("Imagem Comparaçao 2");
        jButtonComp2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jButtonComp2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonComp2MouseClicked(evt);
            }
        });
        jPanel1.add(jButtonComp2);
        jButtonComp2.setBounds(510, 110, 150, 30);

        jTextFieldImagemComp2.setEnabled(false);
        jPanel1.add(jTextFieldImagemComp2);
        jTextFieldImagemComp2.setBounds(670, 110, 370, 30);
        ...
        jLabelProduto1.setBounds(310, 20, 50, 30);
        ...
        jTextFieldTipoProduto.setBounds(360, 20, 140, 30);

        jLabelPrasoPcia1.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabelPrasoPcia1.setText("Loja");
        jPanel4.add(jLabelPrasoPcia1);
        jLabelPrasoPcia1.setBounds(680, 20, 30, 30);
        ...
        jComboBoxPrasoPcia.setBounds(710, 20, 100, 30);
        ...
        jLabelPrasoFabricante1.setBounds(820, 20, 70, 30);
        ...
        jComboBoxAnoFabricante.setBounds(890, 20, 100, 30);
        ...
        jLabeNomeFabricante1.setBounds(10, 20, 100, 30);
        ...
        jTextFieldNomeFabricante.setBounds(110, 20, 190, 30);
        ...
        jLabelCodigoProd1.setBounds(470, 60, 50, 30);
        ...
        jTextFieldCodigoProd.setBounds(520, 60, 160, 30);
        ...
        jLabelSerieImei1.setBounds(10, 60, 100, 30);
        ...
        jTextFieldlSerieImei.setBounds(110, 60, 150, 30);

        jTextFieldIdLaudo1.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jTextFieldIdLaudo1.setEnabled(false);
        jPanel4.add(jTextFieldIdLaudo1);
        jTextFieldIdLaudo1.setBounds(1000, 20, 30, 30);
        ...
        jPanel4.add(jFormattedTextFieldDataLaudo);
        jFormattedTextFieldDataLaudo.setBounds(590, 20, 80, 30);

        jLabelDataLaudo.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabelDataLaudo.setText("Dia do laudo");
        jPanel4.add(jLabelDataLaudo);
        jLabelDataLaudo.setBounds(510, 20, 80, 30);

        jLabelProduto10.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabelProduto10.setText("Modelo");
        jPanel4.add(jLabelProduto10);
        jLabelProduto10.setBounds(270, 60, 50, 30);

        jTextFieldModeloLaudo.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jTextFieldModeloLaudo.setDoubleBuffered(true);
        jPanel4.add(jTextFieldModeloLaudo);
        jTextFieldModeloLaudo.setBounds(320, 60, 140, 30);
        ...
        jPanel4.add(jComboBoxLoja);
        jComboBoxLoja.setBounds(780, 60, 130, 30);

        jLabelTipoLoja.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabelTipoLoja.setText("Loja Comprada");
        jPanel4.add(jLabelTipoLoja);
        jLabelTipoLoja.setBounds(690, 60, 90, 30);

        jPanel1.add(jPanel4);
        jPanel4.setBounds(10, 150, 1040, 110);
        ...
        jButtonSalvarproduto.setBounds(860, 290, 50, 40);
        ...
        jButtonImprimir.setBounds(1000, 290, 50, 40);
        ...
        jButtonDeletarProduto.setBounds(930, 290, 50, 40);

        jTextFieldImagemComp1.setEnabled(false);
        jPanel1.add(jTextFieldImagemComp1);
        jTextFieldImagemComp1.setBounds(180, 110, 320, 30);

        jButtonComp1.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jButtonComp1.setText("Imagem comparaçao 1");
        jButtonComp1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jButtonComp1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonComp1MouseClicked(evt);
            }
        });
        jPanel1.add(jButtonComp1);
        jButtonComp1.setBounds(20, 110, 150, 30);

        jPanelTelaLaudo.add(jPanel1);
        jPanel1.setBounds(10, 60, 1060, 340);
        ...
        jTextFieldIdAutorizada2.setBounds(1000, 70, 30, 30);
        ...
        jComboBoxEstadoFabricante2.setBounds(870, 70, 120, 30);
        ...
        jTextFieldModelo3.setBounds(580, 50, 120, 30);
        ...
        jLabelPrasoPcia5.setBounds(710, 50, 30, 30);
        ...
        jComboBoxPrasoPcia4.setBounds(740, 50, 90, 30);
        ...
        jLabelPrasoFabricante5.setBounds(840, 50, 70, 30);
        ...
        jComboBoxAnoFabricante4.setBounds(910, 50, 90, 30);
        ...
        jTableNomeAutorizada.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableNomeAutorizada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableNomeAutorizadaMouseClicked(evt);
            }
        });
        jScrollPane5.setViewportView(jTableNomeAutorizada);
        ...
        try {
            jFormattedTextFieldContFab1.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("(##)####-####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jFormattedTextFieldContFab1.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jPanelDadosGarantia1.add(jFormattedTextFieldContFab1);
        jFormattedTextFieldContFab1.setBounds(520, 30, 120, 30);
        ...
        try {
            jFormattedTextFieldContFab2.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("(##)####-####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jFormattedTextFieldContFab2.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jPanelDadosGarantia1.add(jFormattedTextFieldContFab2);
        jFormattedTextFieldContFab2.setBounds(720, 30, 120, 30);
        ...
        try {
            jFormattedTextFieldContFab3.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("(##)####-####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jFormattedTextFieldContFab3.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jPanelDadosGarantia1.add(jFormattedTextFieldContFab3);
        jFormattedTextFieldContFab3.setBounds(920, 30, 120, 30);
        ...
        jLabeBairroFabricante1.setBounds(490, 70, 40, 30);
        ...
        jTextFieldBairroFabricante.setBounds(530, 70, 280, 30);
        ...
        jLabeCidadeFabricante1.setBounds(220, 70, 50, 30);
        ...
        jTextFieldCidadeFabricante.setBounds(270, 70, 210, 30);
        ...
        jComboBoxEstadoFabricante.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECIONE", "AC", "AL", "AM", "AP", "BA", "CE", "DF", "ES", "GO", "MA", "MG", "MS", "MT", "PA", "PB", "PE", "PI", "PR", "RJ", "RN", "RO", "RR", "RS", "SC", "SE", "SP", "TO" }));
        ...
        jButtonSalvarAltorizada.setBounds(920, 190, 50, 40);
        ...
        jButtonDeletarAutorizada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonDeletarAutorizadaMouseClicked(evt);
            }
        });
        jPanelDadosGarantia1.add(jButtonDeletarAutorizada);
        jButtonDeletarAutorizada.setBounds(990, 190, 50, 40);
        ...
        jLabeDocNecessario3.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabeDocNecessario3.setText("Pesquisar ");
        jPanelDadosGarantia1.add(jLabeDocNecessario3);
        jLabeDocNecessario3.setBounds(20, 200, 100, 30);

        jTextFieldPesquisaFabricante.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jTextFieldPesquisaFabricante.setDoubleBuffered(true);
        jTextFieldPesquisaFabricante.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldPesquisaFabricanteKeyReleased(evt);
            }
        });
        jPanelDadosGarantia1.add(jTextFieldPesquisaFabricante);
        jTextFieldPesquisaFabricante.setBounds(120, 200, 790, 30);
    ...
    private void jButtonSalvarAltorizadaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSalvarAltorizadaMouseClicked
       //INSERINDO DADOS NO BANCO
        //ESTANCIANDO CLASSIS
        AutorizadaBean p = new AutorizadaBean();
        AutorizacaoCrudClass dao = new AutorizacaoCrudClass();

        //SALVANDO INFORMAÇOES
        p.setNome_Autorizada(jTextFieldNomeAltorizada.getText());
        p.setTel_fixo_fab_1(jFormattedTextFieldContFab1.getText());
        p.setTel_fixo_fab_2(jFormattedTextFieldContFab2.getText());
        p.setTel_fixo_fab_3(jFormattedTextFieldContFab3.getText());
        p.setCep(jFormattedTextFieldCep.getText());
        p.setBairro(jTextFieldBairroFabricante.getText());
        p.setCidade(jTextFieldCidadeFabricante.getText());
        p.setEstado(jComboBoxEstadoFabricante.getSelectedItem().toString());
        p.setEndereco(jTextFieldEnderecoFabricante.getText());
        p.setComplemento(jTextFieldComplementoFabricante.getSelectedText());
        p.setDoc_necesario(jTextFieldDocNecessario.getText());
        
        dao.createAltorizada(p);
    ...
    private void jButtonComp2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonComp2MouseClicked
        ...
        jTextFieldImagemComp2.setText(filename);
    }//GEN-LAST:event_jButtonComp2MouseClicked
    ...
    private void jButtonComp1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonComp1MouseClicked
         //COMANDO PARA CAPTURAR ARQUIVOS DO SISTEMA
        JFileChooser arquivar = new JFileChooser();
        arquivar.showOpenDialog(null);
        File f = arquivar.getSelectedFile();
        String filename = f.getAbsolutePath();
        jTextFieldImagemComp1.setText(filename);
    }//GEN-LAST:event_jButtonComp1MouseClicked
    ...
    private void jFormattedTextFieldCepKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFormattedTextFieldCepKeyReleased
        String cp = jFormattedTextFieldCep.getText();
    ...
    private void jTextFieldPesquisaFabricanteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPesquisaFabricanteKeyReleased
        //PESQUISANDO AUTORIZADA PELO NOME  
      pesquisarAltorizada();        
        
    }//GEN-LAST:event_jTextFieldPesquisaFabricanteKeyReleased

    private void jButtonDeletarAutorizadaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonDeletarAutorizadaMouseClicked
        //DELETANDO DADOS DE TABELA ALTORIZADA        
        //ESTANCIANDO CLASSIS
        AutorizadaBean p = new AutorizadaBean();
        AutorizacaoCrudClass dao = new AutorizacaoCrudClass();
        ...
        dao.auterarAltorizada(p);
        
        
    }//GEN-LAST:event_jButtonDeletarAutorizadaMouseClicked

    private void jTableNomeAutorizadaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableNomeAutorizadaMouseClicked
        // Setando campos 
        preencherAltorizada();
        
    }//GEN-LAST:event_jTableNomeAutorizadaMouseClicked
    ...
    private javax.swing.JButton jButtonComp1;
    private javax.swing.JButton jButtonComp2;
    ...
    private javax.swing.JFormattedTextField jFormattedTextFieldContFab1;
    private javax.swing.JFormattedTextField jFormattedTextFieldContFab2;
    private javax.swing.JFormattedTextField jFormattedTextFieldContFab3;
    ...
    private javax.swing.JLabel jLabeDocNecessario3;
    ...
    private javax.swing.JLabel jLabelProduto10;
    ...
    public javax.swing.JTable jTableNomeAutorizada;
    ...
    private javax.swing.JTextField jTextFieldIdLaudo1;
    private javax.swing.JTextField jTextFieldIdProduto5;
    private javax.swing.JTextField jTextFieldImagemComp1;
    private javax.swing.JTextField jTextFieldImagemComp2;
    private javax.swing.JTextField jTextFieldLaudo;
    private javax.swing.JTextField jTextFieldModelo3;
    private javax.swing.JTextField jTextFieldModeloLaudo;
